...
// disponibilidade e confiabilidade mecânica  (csat);0.32727137
// capacidade operacional (hectares por hora) (csat);0.20331603
// geração e transmissão de dados para gestão da frota (csat);0.07714208
// adaptabilidade as mais diversas condições de trabalho (csat);0.07219156
// facilidade de operação (csat);0.051416982
// adequação as diversas operações e implementos (csat);0.050833084
// facilidade de uso do piloto automático (csat);0.046764392
// facilidade para realização de manutenções (csat);0.04072339
// geração e transmissão de dados para gestão agrícola (csat);0.03928877
// conforto e ergonomia (csat);0.032967497
// consumo de combustível (litros por hectares) (csat);0.031277973
// custo de manutenção (csat);0.026806863
...
// const ctx = document.getElementById('xgbNeutro').getContext('2d');
